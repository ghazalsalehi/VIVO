...
public abstract class TwoFieldsWebFormGenerator  extends VivoBaseGenerator implements EditConfigurationGenerator{
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq, HttpSession session) {
        ...
        conf.setTemplate("twoFieldsWebForm.ftl");
        ...
        conf.setN3Optional(Arrays.asList( 
        		descriptionAssertion, descriptionTypeAssertion ));
       
        conf.addNewResource("obj", DEFAULT_NS_FOR_NEW_RESOURCE);
        
        conf.setUrisOnform(list ());
        conf.setLiteralsOnForm( Arrays.asList("txtDescriptionType","txtDescription"));
