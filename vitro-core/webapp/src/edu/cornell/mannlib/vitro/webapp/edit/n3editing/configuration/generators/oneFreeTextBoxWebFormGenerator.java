...
public abstract class oneFreeTextBoxWebFormGenerator  extends VivoBaseGenerator implements EditConfigurationGenerator{

	final static String vivoCore = "http://www.qut.edu.au/ontologies/vivoqut#";
	final static String textBoxValuePred = vivoCore + "freeTextValue1";
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq, HttpSession session) {
        ...
        conf.setTemplate("oneFreeTextBoxWebForm.ftl");
        ...
        conf.setLiteralsOnForm( Arrays.asList("txtValue"));
        
        conf.addSparqlForExistingLiteral("txtValue", inputValueQuery);
    ...
    final static String inputValueQuery  =  
            "SELECT ?existingValue WHERE {\n"+
            "?obj <"+ textBoxValuePred +"> ?existingValue . }";
    
    final static String inputValueAssertion =
            "?obj <" + textBoxValuePred + "> ?txtValue .";
