...
public class CollectionOrSeriesEditorOfFormGenerator extends RelatedInfoWebFormGenerator{            
	...
	private static String n3ForNewObject =       
            ...
            "?subject core:collectionOrSeriesEditorOf ?obj .\n"+            
	...
	String getDisplayString(){
		return "Collection/Series Editor Of";
	}
	
	@Override
	String getPropertyName(){
		return "collectionOrSeriesEditorOf";
	}
