...
public class ApprovedByOoRFormGenerator extends OneFieldOptionsWebFormGenerator{            
	...
	private static String n3ForNewObject =       
            ...
            "?subject core:isApprovedByOoR  ?obj .\n"+            
	...
	String getDisplayString(){
		return "Approved by OoR";
	}
	
	@Override
	String getPropertyName(){
		return "isApprovedByOoR";
	}
