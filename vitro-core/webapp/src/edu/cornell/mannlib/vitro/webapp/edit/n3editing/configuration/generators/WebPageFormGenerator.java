...
public class WebPageFormGenerator extends RelatedInfoWebFormGenerator{            

private static String vivoCore = "http://www.qut.edu.au/ontologies/vivoqut#";
private static String qutCore = "http://www.qut.edu.au/ontologies/vivoqut#";
	
	private static String n3ForNewObject =       
            "@prefix core1: <"+ vivoCore +"> .\n"+
			"@prefix core2: <"+ qutCore +"> .\n"+
            "?subject core1:webpage  ?obj .\n"+            
            "?obj  a core2:customProperty ";
