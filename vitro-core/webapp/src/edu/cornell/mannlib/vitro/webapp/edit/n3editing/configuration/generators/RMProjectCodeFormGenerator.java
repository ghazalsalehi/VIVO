...
public class RMProjectCodeFormGenerator extends oneFreeTextBoxWebFormGenerator{            
	...
	private static String n3ForNewObject =       
            ...
            "?subject core:RMProjectCode  ?obj .\n"+            
	...
	String getDisplayString(){
		return "RM project code";
	}
	
	@Override
	String getPropertyName(){
		return "RMProjectCode";
	}
