...
public class EmbargoDateWebFormGenerator  extends VivoBaseGenerator implements EditConfigurationGenerator{
  ...
  //Adding form specific data such as edit mode
	public void addFormSpecificData(EditConfigurationVTwo editConfiguration, VitroRequest vreq) {
		...
		formSpecificData.put("propertyName", "embargoDate");
