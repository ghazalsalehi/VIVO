...
public class CurrentMemberOfFormGenerator extends RelatedInfoWebFormGenerator{            
	...
	private static String n3ForNewObject =       
            ...
            "?subject core:currentRelInfoMemberOf  ?obj .\n"+            
	...
	String getDisplayString(){
		return "CurrentMemberOf";
	}
	
	@Override
	String getPropertyName(){
		return "currentRelInfoMemberOf";
	}
