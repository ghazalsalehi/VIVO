...
public class DateMadePublicInRDFWebFormGenerator  extends VivoBaseGenerator implements EditConfigurationGenerator{
	...
	final static String n3ForNewObject =       
            ...
            "?subject core:dateMadePublicInRDF  ?obj .\n"+            
  ...
  //Adding form specific data such as edit mode
	public void addFormSpecificData(EditConfigurationVTwo editConfiguration, VitroRequest vreq) {
		...
		formSpecificData.put("propertyName", "dateMadePublicInRDF");
