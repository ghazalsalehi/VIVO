...
public class PredecessorOrganisationFormGenerator extends RelatedInfoWebFormGenerator{            
	...
	private static String n3ForNewObject =       
            ...
            "?subject core:predecessorOrganisation  ?obj .\n"+            
	...
	String getDisplayString(){
		return "Predecessor Organisation";
	}
	
	@Override
	String getPropertyName(){
		return "predecessorOrganisation";
	}
