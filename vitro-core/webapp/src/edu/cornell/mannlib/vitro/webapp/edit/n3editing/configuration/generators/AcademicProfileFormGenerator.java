...
public class AcademicProfileFormGenerator extends TwoFieldsWebFormGenerator{            
	...
	private static String n3ForNewObject =       
            ...
            "?subject core:academicProfile  ?obj .\n"+            
	...
	@Override
	String getTextAreaSize(){	// normal or bigger
		return "";
	}
	...
	List<String> getFormSpecificData(){
		...
		try {
		    ...
		    while ((str = in.readLine()) != null) {
		    	if (str.equals("[ELECTRONIC_ADDRESS_TYPE]")){
		    		bIsFound = true;
		    		continue;
		    	}
