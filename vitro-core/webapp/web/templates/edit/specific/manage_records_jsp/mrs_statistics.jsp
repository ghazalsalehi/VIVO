            ...
            ${ftl_menu}
				...
				<div class="content-header">
					<div class="mr-menu">
						...
						<li class="page active"><a href="/manageRecords?module=statistics">Statistics</a></li>
						<!-- <li class="page"><a href="/manageRecords?module=siteAdmin">Settings</a></li> -->
					</ul>
					</div>
				</div> 
				<div id="mr-statistics-body">
					<div id="right-col" style="width:100%">
						<p class="individuals-heading" style="color:#FFF;padding-left:8px;margin:0px;font-size: 12px;text-align: center;">Statistics</p>
