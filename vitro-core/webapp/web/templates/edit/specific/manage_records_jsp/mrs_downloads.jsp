            ...
            ${ftl_menu}
				...
				<div class="content-header">
					<div class="mr-menu">
						...
						<li class="page active"><a href="/manageRecords?module=downloads">Downloads</a></li>
				...
				<div id="mr-downloads-body">
					<div id="right-col" style="width:100%">
						<p class="individuals-heading" style="color:#FFF;padding-left:8px;margin:0px;font-size: 12px;text-align: center;">Downloads</p>
						<div class="row">
							<div class="downloadFile"><a href='/manageRecords?module=downloads&key=quickGuide'><div class="downlodImage"></div> Quick guide</a></div>
						</div>
					</div>
				</div>
