...
<section id="individual-intro" class="vcard" role="region">
	...
	<div id="scf-right-col">
		...
		<#if datesOfDevelopment ?? && datesOfDevelopment  != "">
			<div class="scf-right-row">
				<h4>Dates of development</h4>
				<div class="scf-right-row-description">
					${datesOfDevelopment}
				</div>
			</div>
		...
		<#if (hasAssociationWith?? && hasAssociationWith != "") || (hasPrincipalInvestigator?? && hasPrincipalInvestigator != "") || (isManagedBy?? && isManagedBy != "") ||(isOutputOf?? && isOutputOf != "") 
				|| (isOwnedBy?? && isOwnedBy != "") || (hasCollector?? && hasCollector != "") || (linkToexternalRecords?? && linkToexternalRecords != "")>
			<div class="scf-right-row seperate-border">
				<h4>Connections</h4>
