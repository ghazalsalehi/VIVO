<#list propertyGroups.all as group>
	 <#list group.properties as property>
		<#if property.localName == "position">
			<#assign position>
				<@p.objectPropertyPublicView property false />
			</#assign>
		<#elseif property.localName == "biography">
			<#assign biography>
				<@p.objectPropertyPublicView property false />
			</#assign>
...
<section id="individual-intro" class="vcard" role="region">
	<div id="scf-left-col">
		<div class="scf-individual-heading">
			<#if individualImage?? >
				<#if ( individualImage?contains('<img class="individual-photo" src="/images/placeholders/thumbnail.jpg"') )>
				<#else>
			...
			<div id="heading-container">
				<h2 class="selected-class">
					<#if personTitle??>
						<span id="personPrefTitle" style="font-weight: bold;">
							<#if personTitle != "">${personTitle}</#if>
						</span>
					</#if>
	...
	<div id="scf-right-col">
		...
		<#if (fellowOn?? && fellowOn != "") || (principleInvestigatorContactFor?? && principleInvestigatorContactFor != "") || (hasAssociationWith?? && hasAssociationWith != "") || (isCollectorOf?? && isCollectorOf != "") 
			|| (isFundedBy?? && isFundedBy != "") || (isFunderOf?? && isFunderOf != "") || (isManagedBy?? && isManagedBy != "") || (isManagerOf?? && isManagerOf != "") || (isOwnerOf?? && isOwnerOf != "") ||(isParticipantIn?? && isParticipantIn != "") ||
